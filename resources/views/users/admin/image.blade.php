...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            <h5 class="card-title"><i class="fas fa-tag"></i> {{ $user->username }}</h5>
            ...
            <form id="updateImageForm" action="{{ route("users.admin.updateImage", $user->id) }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('POST')
