...
class CartCodesTableSeeder extends Seeder
{
    ...
    public function run(): void
    {
        DB::table('cart_codes')->insert([
            ...
            ['id' => Str::uuid(), 'code' => '42forall', 'percent_discount' => 0.1, 'fixed_discount' => 0.0, 'available_uses' => 5, 'expiration_date' => '2024-04-19', 'created_at' => now(), 'updated_at' => now()],
            ...
            ['id' => Str::uuid(), 'code' => '121314', 'percent_discount' => 0.2, 'fixed_discount' => 0.0, 'available_uses' => 20, 'expiration_date' => '2024-04-19', 'created_at' => now(), 'updated_at' => now()],
